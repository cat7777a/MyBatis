...
<form action="ServletDemo01" method="post" >
...
<table id="main">
    ...
    <tr>
        ...
        <td><input type="text" id="A00" name="case" value="" onblur="check1(this.value)"> <span
                class="error">格式有误</span></td>
    </tr>
    <tr>
        <td><label>消费金额</label></td>
        <td><input type="text" id="A01" name="money" value="" onblur="check2(this.value)"> <span class="ok">格式正确</span>
        </td>
    </tr>
    <tr>
        <td><label>支付方式</label></td>
        <td><select name="pay" id="A02">
    ...
    <tr>
        ...
        <td><input type="date" id="A03" name="time"></td>
    </tr>
